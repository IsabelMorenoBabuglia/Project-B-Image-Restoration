...
for i in range (1, (n-1)):
    for j in range (1, (m-1)):
        ...
        if m_array[i,j]>160:
            ...
            m_array[i,j] = 0
            if m_array[i-1][j]>230 or m_array[i+1][j]>230 or m_array[i][j-1]>230 or m_array[i][j+1]>230:
                inside_array[i,j]= 2
...
np.save(('geometric_w'+str(w)), chi_2_array_0) 

#''' 
chi_0 = np.load('geometric_w1.5.npy')
chi_1 = np.load('geometric_w1.0.npy')
chi_2 = np.load('geometric_w0.5.npy')
